...
input_file = '/bigdisk/users/kelvi/best_pdb_full.txt'
pdb_folder = '/bigdisk/users/kelvi/data/pdb_af/'
output_file = 'distance_af.tsv'
o2 = 'not_found_id_af.txt'
...
with open(output_file, 'w', newline='') as f_output, open(o2, 'w') as f_not_found:
    ...
    for _, row in data.iterrows():
        ...
        result = select_atoms(pdb_folder, pdb_id, chain_id, unp, domain1_name, domain1_start, domain1_end, domain2_name, domain2_start, domain2_end)
